...
**Screenshot:** `../../media/01_class_distribution.png`
...
**Screenshot:** `../../media/02_feature_distributions.png`
...
**Screenshot:** `../../media/03_rainfall_slope_ndvi_boxplots.png`
...
**Screenshot:** `../../media/04_soil_boxplots.png`
...
**Screenshot:** `../../media/05_correlation_heatmap.png`
...
**Screenshot:** `../../media/06_top_features_violinplot.png`
